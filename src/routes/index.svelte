<script context="module">
	export async function load({ fetch }) {
		...
		return { props: { built, contributed } };
	}
</script>
...
<svelte:head>
	...
	<meta property="og:image" content="https://www.kirillvasiltsov.com/home.png" />
	...
	<meta name="twitter:image" content="https://www.kirillvasiltsov.com/home.png" />
</svelte:head>
	...
	<div class="max-width content">
		<section>
			...
			<p class="greeting-introduce">
				I am a software developer. I love building user interfaces and creating performant tools
				that everyone needs in their everyday hacking.
			</p>
		</section>
		<section>
		...
		<section>
			...
			<ul class="misc-built">
				...
				<li class="misc-built__item">
					<a href="https://iskra-playground.vercel.app/">Iskra language playground</a>
				</li>
			</ul>
		</section>
		<section class="appearances">
			...
			<ul class="appearances-list">
				<li class="appearances-list__item">
					<a href="https://sveltesummit.com/"> Svelte Summit 2020 (Worldwide, Online) </a>
				</li>
				<li class="appearances-list__item">
