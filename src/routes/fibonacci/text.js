...
export const text = {
  ...
  ru: {
    ...
    Так было пока я не прочел замечательную книгу <a href="https://mitpress.mit.edu/books/rhyme-and-reason">"Rhyme and Reason"</a>
     написанную Хуаном Уриагерека во время написания магистерской по лингвистике. Книга не про сосновые шишки,
    ...
    sec8: `"Правильный" ответ: 0.618 (или 0.382 что равно 1 - 0.618). Вернитесь и попробуйте ввести это число. 
    Число 1.618 известно как <a href="https://ru.wikipedia.org/wiki/%D0%97%D0%BE%D0%BB%D0%BE%D1%82%D0%BE%D0%B5_%D1%81%D0%B5%D1%87%D0%B5%D0%BD%D0%B8%D0%B5">Золотое Сечение</a>. 
    Судя по всему, поворот на золотое сечение раз каждый при размещении семени позволяет разместить их 
    наиболее эффективно, используя максимум свободного физического пространства. В данном контексте, 0.618 поворотов это
     то же самое что и 1.618 поворотов. Какое это отношение имеет к числам Фибоначчи? Если вы возьмете 
     два числа Фибоначчи-соседа, и разделите их так что делитель больше делимого (например 13 на 8), вы
      получите число очень близкое к Золотому Сечению.`,
    sec9: `Обратите внимание что Золотое Сечение это иррациональное число. Вы никогда не получите именно его,
       деля числа Фибоначчи. Несмотря на его "иррациональность", я восхищен тем, что наиболее пространственно экономный способ 
       разместить семена и листья не случаен и что его можно описать языком математики.`,
  },
};
